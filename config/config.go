...
var (
	...
	FrontendAddress = readString("FRONTEND_ADDRESS", "http://localhost")
	...
	FrontendHost = readString("FRONTEND_HOST", "http://localhost:3000")
	...
	MaxRequstsPerMinute = readInt("MAX_REQUESTS_PER_MINUTE", 4*60)
